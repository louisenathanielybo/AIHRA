                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    @auth
                        @if(Auth::user()->role === 'Admin')
                            ...
                            <x-nav-link :href="route('admin.assigned-items.index')" :active="request()->routeIs('admin.assigned-items.*')">
                                {{ __('Assigned Items') }}
                            </x-nav-link>
        ...
        <div class="pt-2 pb-3 space-y-1">
            @auth
                @if(Auth::user()->role === 'Admin')
                    ...
                    <x-responsive-nav-link :href="route('admin.assigned-items.index')" :active="request()->routeIs('admin.assigned-items.*')">
                        {{ __('Assigned Items') }}
                    </x-responsive-nav-link>
                @elseif(Auth::user()->role === 'HR')
